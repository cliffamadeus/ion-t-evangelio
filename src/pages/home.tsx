...
const cardData = [
  {
    ...
    subtitle: 'Applet #1',
    link: 'ion-t-evangelio/clickcounter',
    tags: {
      tag1: logoIonic,
      tag2: logoReact
    }
  ...
  },
  {
    ...
    icon: calculator,
    subtitle: 'Applet #2',
    link: 'ion-t-evangelio/calculator',
    tags: {
      tag1: logoIonic,
      tag2: logoReact
    }
  ...
  },
  {
    ...
    icon: chatbubble,
    subtitle: 'Applet #4',
    link: 'ion-t-evangelio/quotegenerator',
    tags: {
      tag1: logoIonic,
      tag2: logoReact
    }
